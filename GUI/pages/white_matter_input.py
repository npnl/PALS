...
class WhiteMatterInputPage(BaseInputPage, object):
	def __init__(self, parent, controller, frame_number):
		...
		lf_wm_seg = tk.LabelFrame(self, text='WM Segmentation', padx=15, font='Helvetica 14 bold')
		...
		lb_wm_id = Label(lf_wm_seg, text="White Matter ID") #.grid(row=self.starting_row+2, sticky=W)
