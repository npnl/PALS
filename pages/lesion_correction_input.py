...
class LesionCorrInputPage(BaseInputPage, object):
	def __init__(self, parent, controller, frame_number):
		...
		createToolTip(lf_wm_seg, self.controller.desc.wm_seg)
		...
		createToolTip(lb_wm_id, self.controller.desc.wm_identifier)
		...
		createToolTip(en_wm_id, self.controller.desc.wm_identifier)
		...
		createToolTip(chk_wm_seg, self.controller.desc.wm_seg)
		...
		createToolTip(lb_percent, self.controller.desc.percent)
